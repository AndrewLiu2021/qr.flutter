...
class QrPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawFinderPatternItem(
      ...
      canvas,
      paintMetrics,
      shader: eyeStyle.finderPatternShader?.topLeft,
    );
    _drawFinderPatternItem(
      FinderPatternPosition.bottomLeft,
      canvas,
      paintMetrics,
      shader: eyeStyle.finderPatternShader?.bottomLeft,
    );
    _drawFinderPatternItem(
      FinderPatternPosition.topRight,
      canvas,
      paintMetrics,
      shader: eyeStyle.finderPatternShader?.topRight,
    );
...
//        paint);
  ...
  void _drawFinderPatternItem(FinderPatternPosition position, Canvas canvas, _PaintMetrics metrics,
      {QrEyeShapeShader? shader}) {
    ...
    if (shader != null) {
      outerPaint.shader =
          ui.Gradient.linear(offset + shader.begin * radius, offset + shader.end * radius, shader.colors);
    } else {
